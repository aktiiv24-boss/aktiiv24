...
const translations = {
  ...
  en: {
    ...
    statExperienceNumber: "25+ years", statExperience: "experience", statFinland: "work across Finland", statToolsNumber: "100 %", statTools: "own tools", statClients: "private and business clients",
  ...
  et: {
    ...
    statExperienceNumber: "25+ aastat", statExperience: "kogemust", statFinland: "tööd Soomes", statToolsNumber: "100 %", statTools: "oma tööriistad", statClients: "erakliendid ja ettevõtted",
  ...
  ru: {
    ...
    statExperienceNumber: "25+ лет", statExperience: "опыта", statFinland: "работа по Финляндии", statToolsNumber: "100 %", statTools: "свои инструменты", statClients: "частные и компании",
